...
475 | [C](codeforces/475/C.cpp)  | `brute force` `constructive algorithms` `greedy` `*2100`
...
476 | [B](codeforces/476/B.cpp)  | `bitmasks` `brute force` `combinatorics` `dp` `math` `probabilities` `*1300`
...
477 | [C](codeforces/477/C.cpp)  | `dp` `*2200`
